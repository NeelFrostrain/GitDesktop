...
pub async fn listen_for_oauth_callback(
    ...
    let html_response = concat!(
        ...
        "Connection: close\r\n\r\n",
        "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>GitDesktop &ndash; Signed In</title><style>",
        "*{box-sizing:border-box;margin:0;padding:0}",
        "body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#0b0a0e;background-image:radial-gradient(ellipse 80% 40% at 50% -10%,rgba(224,86,56,.14) 0%,transparent 70%);color:#e6e4e8;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:24px;user-select:none;-webkit-user-select:none}",
        ".card{width:100%;max-width:380px;background:#111013;border:1px solid #29272b;border-radius:10px;padding:32px 28px 24px;text-align:center;box-shadow:0 32px 64px -16px rgba(0,0,0,.8)}",

        ".check{width:48px;height:48px;margin:0 auto 18px;border-radius:50%;background:rgba(16,185,129,.08);border:1px solid rgba(16,185,129,.2);display:flex;align-items:center;justify-content:center}",
        ".check svg{color:#10b981}",
        "h1{font-size:18px;font-weight:700;color:#fff;margin-bottom:8px;letter-spacing:-.01em}",
        "p{font-size:12.5px;color:#85818c;line-height:1.55;margin-bottom:24px}",
        ".hint{font-size:11px;color:#4a4852;margin-bottom:16px}",
        ".btn{display:inline-flex;align-items:center;justify-content:center;width:100%;padding:9px 16px;background:#1e1c21;border:1px solid #29272b;color:#e6e4e8;font-size:12.5px;font-weight:600;border-radius:6px;cursor:pointer;transition:border-color .15s}",
        ".btn:hover{border-color:#3d3a42}",
        "</style></head>",
        "<body><div class=\"card\">",

        "<div class=\"check\"><svg width=\"22\" height=\"22\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M20 6L9 17l-5-5\"/></svg></div>",
        "<h1>Account Connected</h1>",
        "<p>Your account has been authorised.<br>You can return to GitDesktop now.</p>",
        "<p class=\"hint\">This window will close automatically&hellip;</p>",
