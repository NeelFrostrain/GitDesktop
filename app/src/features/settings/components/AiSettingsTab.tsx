...
const MODEL_OPTIONS = [
  {
    ...
    badge: 'Ultra Fast',
    desc: 'Lightning-fast execution (~800ms) with optimized token usage and generous free tier quotas on Google AI Studio.',
  },
  {
    id: 'gemini-3.6-flash',
    name: 'Gemini 3.6 Flash',
    subtitle: 'Flagship Next-Gen Multimodal',
    badge: 'Next-Gen',
    desc: 'Google flagship next-generation multimodal model with state-of-the-art code analysis and diff intelligence.',
  },
  {
    id: 'gemini-3.5-flash',
    name: 'Gemini 3.5 Flash',
    subtitle: 'High-Speed Multimodal',
    badge: 'Fast',
    desc: 'High-capability multimodal reasoning model with ultra-fast latency for large codebases and PR reviews.',
  },
  {
    ...
    badge: 'High-Speed',
    desc: 'Balanced reasoning speed and contextual accuracy for conventional commit message formatting.',
  },
  {
    id: 'gemini-3.7-flash',
    name: 'Gemini 3.7 Flash',
    subtitle: 'State-of-the-Art • Deep Reasoning',
    badge: 'State-of-Art',
    desc: 'Cutting-edge reasoning model with thinking capabilities for architecture and deep Git diff analysis.',
  },
];
