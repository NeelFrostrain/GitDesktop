  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute top-0 right-0 w-1.5 h-full cursor-col-resize z-30 transition-colors flex items-center justify-center ${
          isResizing ? 'bg-commito-coral' : 'hover:bg-commito-coral/60'
        }`}
      >
        <div className={`w-0.5 h-8 rounded-full transition-colors ${
          isResizing ? 'bg-white' : 'bg-border group-hover/sidebar:bg-commito-coral/80'
        }`} />
      </div>
