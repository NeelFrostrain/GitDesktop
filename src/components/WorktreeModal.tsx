      ...
      <div className="bg-base-1 border border-border rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="px-5 py-3.5 bg-base-0 border-b border-border flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-gitlab-teal/20 border border-gitlab-teal/40 text-gitlab-teal flex items-center justify-center">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <form onSubmit={handleCreateWorktree} className="p-4 bg-base-2 border border-border rounded-xl space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {worktrees.map((wt) => (
                <div
                  key={wt.path}
                  className="p-3 bg-base-2 border border-border rounded-xl flex items-center justify-between hover:border-text-muted transition"
                >
