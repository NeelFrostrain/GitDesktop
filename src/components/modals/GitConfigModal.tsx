...
export const GitConfigModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 flex items-center justify-center p-4 select-none font-sans">
      <div className="bg-base-1 border border-border rounded-sm shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col h-[85vh] animate-in fade-in zoom-in-95 duration-150">
        {/* Modal Header */}
            ...
            <form onSubmit={handleSaveGitignore} className="space-y-4 flex flex-col h-full">
              ...
              <div className="pt-2 flex justify-end gap-2">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-commito-coral hover:bg-commito-coralLight text-white rounded-sm text-xs font-bold transition shadow-xs flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="p-3.5 bg-base-2 border border-border rounded-sm space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 bg-commito-coral hover:bg-commito-coralLight text-white rounded-sm text-xs font-bold transition shadow-xs cursor-pointer disabled:opacity-50"
                  >
                    Save
                  </button>
                </div>
              ...
              <div className="space-y-1.5">
                ...
                {configItems.length === 0 ? (
                  <div className="p-6 text-center bg-base-2 border border-border rounded-sm text-xs text-text-muted italic">
