    ...
    <div className="fixed inset-0 z-50 bg-black/75 flex items-center justify-center p-4 select-none font-sans">
      <div className="bg-base-1 border border-border rounded-sm shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <form onSubmit={handleCreateWorktree} className="p-4 bg-base-2 border border-border rounded-sm space-y-3">
            ...
            <div className="flex justify-end pt-1">
              <button
                ...
                className={`px-4 py-1.5 bg-commito-coral hover:bg-commito-coralLight text-white rounded-sm text-xs font-bold flex items-center gap-1.5 transition shadow-xs cursor-pointer disabled:opacity-50`}
              >
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {worktrees.map((wt) => (
                <div
                  key={wt.path}
                  className="p-3 bg-base-2 border border-border rounded-sm flex items-center justify-between hover:border-text-muted transition"
                >
