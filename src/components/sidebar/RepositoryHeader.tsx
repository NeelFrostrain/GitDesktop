      ...
      <div className="px-2.5 py-2 border-b border-border/40 bg-base-0 select-none flex items-stretch justify-between gap-1.5">
        ...
        <div className="flex-1 min-w-0 h-8 bg-base-1/90 border border-border/60 rounded-sm p-0.5 flex items-center gap-0.5 shadow-xs">
          <button
            ...
            className={`flex-1 min-w-0 h-full px-1.5 text-xs rounded-sm flex items-center justify-center gap-1 transition-all duration-150 cursor-pointer ${
              activeTab === 'changes'
          ...
          >
            ...
            <span
              className={`inline-flex items-center justify-center min-w-[16px] h-4 px-1 rounded-sm text-[9.5px] font-mono font-bold leading-none transition-all duration-150 flex-shrink-0 ${
                fileCount > 0
                  ? activeTab === 'changes'
