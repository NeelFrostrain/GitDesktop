...
export const CommitPanel: React.FC = () => {
  ...
  const [descriptionMode, setDescriptionMode] =
    useState<DescriptionMode>("report");
  ...
  const { getEffectiveValue, setSettingValue, openSettings } =
    useSettingsStore();
  ...
  const handleApplyAiSelection = (titleOverride?: string) => {
    const chosenTitle =
      titleOverride ||
      aiTitleOptions[selectedTitleIndex] ||
      aiTitleOptions[0] ||
      "";
    ...
    try {
      ...
      useLogStore
        ...
        .addLog(
          "error",
          "Git",
          `[Commit-AI] Key verification failed: ${errMsg}`,
        );
    } finally {
          ...
          {isApiKeyPrompt ? (
            <div className="flex flex-col gap-2.5 animate-in fade-in duration-100 font-sans text-xs">
              <p className="text-[11px] text-text-muted leading-relaxed">
                Enter your free Google Gemini API key to generate commit titles
                and technical reports with Commit-AI.
              </p>
              ...
              <div className="p-2.5 bg-base-0 border border-border rounded-sm space-y-1.5 text-[11px]">
                ...
                <ol className="list-decimal list-inside text-text-muted text-[10.5px] space-y-0.5 pl-0.5">
                  ...
                  <li>
                    ...
                    <code className="font-mono text-commito-coral">
                      AIza...
                    </code>
                  </li>
              ...
              {/* Key Input Form */}
              <form
                onSubmit={handleSaveKeyAndGenerateInline}
                className="space-y-2"
              >
                <input
                  ref={keyInputRef}
            ...
            <>
              ...
              <div className="flex items-center justify-between px-0.5 select-none -mt-1">
                <div className="flex items-center gap-1">
                  ...
                  <CommitActions
                    isVisible={Boolean(
                      commitSummary.trim() || commitDescription.trim(),
                    )}
                    onClear={clearForm}
                  />
                </div>
