...
export const ProviderBadge: React.FC<ProviderBadgeProps> = ({ provider, className = '' }) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-base-3 border border-border text-text-primary text-[11px] font-bold tracking-wide select-none ${className}`}
    >
      <svg className="w-3 h-3 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
