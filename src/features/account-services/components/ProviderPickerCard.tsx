    ...
    <div className="space-y-5 select-none">
      ...
      <div className="grid grid-cols-3 gap-3.5">
        ...
        <div
          ...
          className={`p-4 rounded-md border transition-all cursor-pointer flex flex-col items-center justify-center text-center space-y-2.5 ${selectedProvider === 'gitlab'
            ? 'bg-base-2 border-[#fc6d26] ring-2 ring-[#fc6d26]/20 shadow-md'
            : 'bg-base-2/50 border-border hover:border-border-strong hover:bg-base-2'
            }`}
        >
          <div className="w-10 h-10 rounded-md bg-[#fc6d26]/15 flex items-center justify-center text-[#fc6d26]">
        ...
        <div
          ...
          className={`p-4 rounded-md border transition-all cursor-pointer flex flex-col items-center justify-center text-center space-y-2.5 ${selectedProvider === 'github'
            ? 'bg-base-2 border-text-primary ring-2 ring-white/10 shadow-md'
            : 'bg-base-2/50 border-border hover:border-border-strong hover:bg-base-2'
            }`}
        >
          <div className="w-10 h-10 rounded-md bg-base-3 flex items-center justify-center text-text-primary">
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="p-4 rounded-md border border-dashed border-border bg-base-2/20 opacity-50 flex flex-col items-center justify-center text-center space-y-2.5 cursor-not-allowed">
          <div className="w-10 h-10 rounded-md bg-base-3 flex items-center justify-center text-text-muted text-xs font-bold font-mono">
            +
          </div>
          <div>
      ...
      <form onSubmit={handleContinue} className="p-4 bg-base-2/40 border border-border rounded-md space-y-4">
        {error && (
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-base-1 border border-border rounded-md px-3 py-2 text-xs font-mono text-text-primary placeholder-text-muted focus:outline-none focus:border-commito-coral transition"
            required
          />
        </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <button
            type="submit"
            disabled={isWaiting}
            className="px-4 py-2 bg-[#fc6d26] hover:bg-[#e24329] text-white rounded-md text-xs font-bold transition flex items-center gap-2 cursor-pointer shadow-md"
          >
            {isWaiting ? (
              <>
