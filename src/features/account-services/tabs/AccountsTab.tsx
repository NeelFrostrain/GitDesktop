    ...
    <div className="space-y-4 select-none">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-4 py-2 bg-gitlab-orange hover:bg-commito-coral-hover text-white rounded-sm text-xs font-bold transition flex items-center gap-1.5 cursor-pointer shadow-md flex-shrink-0"
        >
      ...
      {accounts.length > 0 ? (
        ...
        /* Empty State */
        <div className="p-10 border border-dashed border-border rounded-sm bg-base-2/20 text-center space-y-3">
          ...
          <button
            onClick={() => setActiveTab('add')}
            className="px-4 py-2 bg-gitlab-orange hover:bg-commito-coral-hover text-white rounded-sm text-xs font-bold transition inline-flex items-center gap-1.5 cursor-pointer shadow-md"
          >
            <Plus className="w-4 h-4 stroke-[2.5]" />
