    ...
    <div className="space-y-4 select-none">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-base-2 hover:bg-base-3 border border-border text-text-secondary hover:text-text-primary rounded-lg text-xs font-semibold transition flex items-center gap-1.5 cursor-pointer"
        >
