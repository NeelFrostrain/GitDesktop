...
export const ToolCallCard: React.FC<ToolCallCardProps> = ({ toolCall }) => {
  ...
  return (
    <div className="rounded-sm border border-border/80 bg-base-1/50 hover:bg-base-1/70 p-2.5 flex items-center justify-between gap-3 shadow-sm transition group/card select-none">
      {/* Left: Badge & Details */}
