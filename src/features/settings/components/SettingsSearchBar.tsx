  ...
  return (
    <div className="relative flex-1 max-w-lg">
      ...
      <input
        ...
        className="w-full pl-9 pr-16 py-1.5 bg-base-2 border border-border rounded-lg text-xs text-text-primary placeholder:text-text-muted focus:outline-none focus:border-commito-coral transition"
      />
