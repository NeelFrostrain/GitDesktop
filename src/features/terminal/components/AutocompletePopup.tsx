...
export const AutocompletePopup: React.FC<AutocompletePopupProps> = ({
  ...
  return (
    <div
      ...
      className="absolute z-50 w-[420px] max-h-[260px] bg-base-2 border border-border shadow-2xl rounded-sm overflow-hidden flex flex-col font-sans select-none animate-in fade-in zoom-in-95 duration-100"
    >
      {/* Header bar */}
